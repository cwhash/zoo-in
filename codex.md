...
- `README.md` is for end users and players, and must be **English-only**.
- `readme_zh.md` is the Traditional Chinese translation of `README.md`.
...
- When product-facing behavior changes, update both `README.md` and `readme_zh.md`.
...
- Remove developer/demo-only UI from the homepage unless explicitly requested.

## 6. Change Management
- Keep edits small and easy to review.
- If a change affects user behavior or visuals, update both user-facing README files.
